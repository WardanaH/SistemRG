                    ...
                    <table class="table align-items-center mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Peminta Bantuan</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                {{-- KOLOM 2: DETAIL CABANG --}}
                                <td>
                                    <h6 class="mb-0 text-sm">{{ $spk->cabangAsal->nama }}</h6>
                                </td>
                                ...
                                <td class="align-middle text-end pe-4">
                                    <div class="d-flex justify-content-end align-items-center gap-2">
                                        ...
                                        {{-- TOMBOL 2: CETAK --}}
                                        <a href="{{ route('spk-bantuan.cetak-spk-bantuan', $spk->id) }}" target="_blank" class="badge bg-gradient-primary text-white text-xs" data-toggle="tooltip" title="Cetak SPK" style="text-decoration: none;">

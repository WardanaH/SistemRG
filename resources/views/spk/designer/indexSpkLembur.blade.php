    ...
    <div class="col-12">
        <div class="card my-4">
            ...
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 mb-3">
                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3 d-flex justify-content-between align-items-center px-3">
                    <div class="d-flex align-items-center">
                        <h6 class="text-white text-capitalize mb-0">Daftar SPK Lembur</h6>
            ...
            <div class="card-body px-3 pb-2">
                ...
                <form action="{{ route('spk-lembur.index') }}" method="GET" class="mb-4 bg-gray-100 p-3 border-radius-lg">
                    <div class="row align-items-end">
                        ...
                        <div class="col-md-4 col-sm-6 mb-2">
                            ...
                            <input type="text" name="search" class="form-control border px-2 text-sm bg-white" placeholder="No SPK / Pelanggan / Designer..." value="{{ request('search') }}">
                        </div>
                        ...
                        <div class="col-md-2 col-sm-12 mb-2 d-flex gap-2">
                            ...
                            <a href="{{ route('spk-lembur.index') }}" class="btn btn-sm btn-outline-danger w-100 mb-0" title="Reset Filter">
                    ...
                    <table class="table align-items-center mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Designer & Cabang</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                    ...
                                    <div class="d-flex px-2 py-1">
                                        <div>
                                            <div class="avatar avatar-sm me-3 border-radius-lg bg-gradient-warning d-flex align-items-center justify-content-center">
                                                <i class="material-icons text-white text-sm">nightlight_round</i>
                                            </div>
                                        </div>
                                ...
                                {{-- KOLOM 4: DESIGNER & CABANG LEMBUR --}}
                                <td>
                                    <p class="text-xs font-weight-bold mb-0">{{ $spk->designer->nama ?? '-' }}</p>
                                    <p class="text-xxs text-secondary mb-0">Ke: {{ $spk->cabang->nama ?? 'Pusat' }}</p>
                                </td>
                            ...
                            <tr>
                                <td colspan="6" class="text-center py-5">
                                    <h6 class="text-secondary font-weight-normal">Belum ada data SPK Lembur yang sesuai filter.</h6>
                                </td>
                            </tr>
                            @endforelse
                        </tbody>

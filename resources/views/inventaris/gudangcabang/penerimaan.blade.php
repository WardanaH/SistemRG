                            ...
                            <tbody>
                                @foreach($riwayat as $index => $r)
                                    <tr>
                                        ...
                                        <td class="fw-bold">
                                            {{ collect(is_array($r->keterangan) ? $r->keterangan : json_decode($r->keterangan, true) ?? [])->pluck('nama_barang')->implode(', ') }}
                                        </td>

                                        <td>
                                            {{ collect(is_array($r->keterangan) ? $r->keterangan : json_decode($r->keterangan, true) ?? [])->pluck('jumlah')->implode(', ') }}
                                        </td>

                                        <td>
                                            {{ collect(is_array($r->keterangan) ? $r->keterangan : json_decode($r->keterangan, true) ?? [])->pluck('satuan')->implode(', ') }}
                                        </td>
